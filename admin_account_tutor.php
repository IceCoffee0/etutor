<?php 
    ...
    $thisPage = "admin_account_tutor.php";
    ...
    $total_pages_sql = "SELECT COUNT(*) FROM users WHERE role_id = 1";
    $result = queryMysql($total_pages_sql);
    $total_rows = $result->fetch_array()[0];
    $total_pages = ceil($total_rows / $no_of_records_per_page);

    $sql = "SELECT * FROM users WHERE role_id = 1 LIMIT $offset, $no_of_records_per_page";
                    ...
                    <div class="dialog overlay" id="my-dialog">
                        ...
                        <div class="dialog-body">
                            ...
                            <form action="register_func.php" method="post">
                                ...
                                <h1 style="text-align: center; color: white;">Add new tutor</h1>
                                <div>
                                    ...
                                    <input style="font-family: Poppins-Medium;
                                                ...
                                                height: 30px;
                                                border-radius: 5px;
                                                margin-left: 92px;" type="text" placeholder="" required minlength="8" id="" name="fullname" />
                                    </p>
                                </div>
                                <div>
                                    <p style="font-size: 24pt; color: white; padding-left: 78px;">Phone number:
                                        <input style="font-family: Poppins-Medium;
                                                ...
                                                height: 30px;
                                                border-radius: 5px;
                                                margin-left: 14px;" type="number" placeholder="" required minlength="10" id="" name="phone"/>
                            </p>
                                    </p>
                                </div>
                                <div>
                                    <p style="font-size: 24pt; color: white; padding-left: 78px;">Email:
                                        <input style="font-family: Poppins-Medium;
                                                ...
                                                height: 30px;
                                                border-radius: 5px;
                                                margin-left: 145px;" type="email" placeholder="" required minlength="8" id="" name="email"/>
                            </p>
                                    </p>
                                </div>
                                <div>
                                    <a href="admin_account_tutor.php"><input style="
                                    background: #3f3731;
                                    width: 100px;
                                    height: 40px;
                ...
                <table class="table table-color">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    $students = count(getTutorsStudent($row['user_id']));
                                    echo $students;
                                ?>
                            </td>
                            <td>
                                ...
                                <form action="register_func.php" method="post">
                                    ...
                                    <div>
                                        ...
                                        <input style="font-family: Poppins-Medium;
                                                    ...
                                                    height: 30px;
                                                    border-radius: 5px;
                                                    margin-left: 92px;" type="text" placeholder="" required minlength="8" id="" name="fullname" value="<?= $row['fullname']?>"/>
                                        </p>
                                    </div>
                                    <div>
                                        <p style="font-size: 24pt; color: white; padding-left: 78px;">Phone number:
                                            <input style="font-family: Poppins-Medium;
                                                    ...
                                                    height: 30px;
                                                    border-radius: 5px;
                                                    margin-left: 14px;" type="number" placeholder="" required minlength="10" id="" name="phone" value="<?= $row['phone']?>"/>
                                        </p>
                                        </p>
                                    </div>
                                    <div>
                                        <p style="font-size: 24pt; color: white; padding-left: 78px;">Email:
                                            <input style="font-family: Poppins-Medium;
                                                    ...
                                                    height: 30px;
                                                    border-radius: 5px;
                                                    margin-left: 145px;" type="email" placeholder="" required minlength="10" id="" name="email" value="<?= $row['email']?>"/>
                                        </p>
                                        </p>
                                    </div>
                                    <div>
